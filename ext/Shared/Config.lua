...
Config = {
	...
	-- DIFFICULTY 
BotAimWorsening = 1.0,
BotSniperAimWorsening = 1.5,
BotSupportAimWorsening = 1.2,
BotWorseningSkill = 0.8,
BotSniperWorseningSkill = 0.7,
ReactionTime = 0.6,
DamageFactorAssault = 0.1,
DamageFactorCarbine = 0.1,
DamageFactorLMG = 0.1,
DamageFactorPDW = 0.1,
DamageFactorSniper = 0.1,
DamageFactorShotgun = 0.1,
DamageFactorPistol = 0.1,
DamageFactorKnife = 0.0,
VehicleAimWorsening = 0.8,
VehicleAAAMWorsening = 1.5,
VehicleGunshipAimWorsening = 1.5,
VehicleChopperAimWorsening = 1.2,
VehiclePlaneAimWorsening = 1.0,
