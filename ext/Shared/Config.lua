...
Config = {
	...
	-- DIFFICULTY 
	BotAimWorsening = 0.99,				-- Make bots aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	BotSniperAimWorsening = 0.99,		-- See botAimWorsening, only for Sniper-rifles 
	BotSupportAimWorsening = 0.99,		-- See botAimWorsening, only for LMGs 
	BotWorseningSkill = 0.99,			-- Variation of the skill of a single bot. The higher, the worse the bots can get compared to the original settings 
	BotSniperWorseningSkill = 0.99,		-- See BotWorseningSkill - only for BOTs using sniper bolt-action rifles 
	ReactionTime = 0.2,					-- Additional delay for bots, dependant of skill (might also be 0) 
	DamageFactorAssault = 0.99,			-- Original Damage from bots gets multiplied by this 
	DamageFactorCarabine = 0.99,			-- Original Damage from bots gets multiplied by this 
	DamageFactorLMG = 0.99,				-- Original Damage from bots gets multiplied by this 
	DamageFactorPDW = 0.99,				-- Original Damage from bots gets multiplied by this 
	DamageFactorSniper = 0.99,			-- Original Damage from bots gets multiplied by this 
	DamageFactorShotgun = 0.99,			-- Original Damage from bots gets multiplied by this 
	DamageFactorPistol = 0.99,			-- Original Damage from bots gets multiplied by this 
