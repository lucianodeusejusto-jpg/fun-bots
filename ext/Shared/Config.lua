...
Config = {
	...
	BotSniperAimWorsening = 1.0,		-- See botAimWorsening, only for Sniper-rifles 
	BotSupportAimWorsening = 1.0,		-- See botAimWorsening, only for LMGs 
	...
	DamageFactorAssault = 0.1,			-- Original Damage from bots gets multiplied by this 
	DamageFactorCarabine = 0.1,			-- Original Damage from bots gets multiplied by this 
	DamageFactorLMG = 0.1,				-- Original Damage from bots gets multiplied by this 
	DamageFactorPDW = 0.1,				-- Original Damage from bots gets multiplied by this 
	DamageFactorSniper = 0.1			-- Original Damage from bots gets multiplied by this 
	DamageFactorShotgun = 0.1,			-- Original Damage from bots gets multiplied by this 
	DamageFactorPistol = 0.1,			-- Original Damage from bots gets multiplied by this 
	DamageFactorKnife = 0.0,			-- Original Damage from bots gets multiplied by this 
	VehicleAimWorsening = 0.8,			-- Make bots in vehicles aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehicleAAAimWorsening = 1.5,		-- Make bots in AA aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehicleGunshipAimWorsening = 1.5,	-- Make bots in Gunships aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehicleChopperAimWorsening = 1.2,	-- Make bots in Choppers aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehiclePlaneAimWorsening = 1.0,	-- See VehicleAimWorsening, only for Planes 
