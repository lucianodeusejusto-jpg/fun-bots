...
Config = {
	...
	-- DIFFICULTY 
	BotAimWorsening = 1.50,				-- Make bots aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	BotSniperAimWorsening = 3.00,		-- See botAimWorsening, only for Sniper-rifles 
	BotSupportAimWorsening = 3.00,		-- See botAimWorsening, only for LMGs 
	BotWorseningSkill = 2.00,			-- Variation of the skill of a single bot. The higher, the worse the bots can get compared to the original settings 
	BotSniperWorseningSkill = 1.50,		-- See BotWorseningSkill - only for BOTs using sniper bolt-action rifles 
	ReactionTime = 1.50,					-- Additional delay for bots, dependant of skill (might also be 0) 
	...
	VehicleAimWorsening = 1.50,			-- Make bots in vehicles aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehicleAAAimWorsening = 1.50,		-- Make bots in AA aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehicleGunshipAimWorsening = 1.50,	-- Make bots in Gunships aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehicleChopperAimWorsening = 1.50,	-- Make bots in Choppers aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehiclePlaneAimWorsening = 1.50,	-- See VehicleAimWorsening, only for Planes 
	DamageFactorVehicles = 0.50,			-- Original Damage from bots in vehicles gets multiplied by this 
