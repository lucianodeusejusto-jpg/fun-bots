...
Config = {
	...
	-- DIFFICULTY 
	BotAimWorsening = 7.0,				-- Make bots aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	BotSniperAimWorsening = 7.1,		-- See botAimWorsening, only for Sniper-rifles 
	BotSupportAimWorsening = 7.3,		-- See botAimWorsening, only for LMGs 
	BotWorseningSkill = 7.40,			-- Variation of the skill of a single bot. The higher, the worse the bots can get compared to the original settings 
	BotSniperWorseningSkill = 7.30,		-- See BotWorseningSkill - only for BOTs using sniper bolt-action rifles 
	ReactionTime = 0.2,					-- Additional delay for bots, dependant of skill (might also be 0) 
	DamageFactorAssault = 0.77,			-- Original Damage from bots gets multiplied by this 
	DamageFactorCarabine = 0.77,			-- Original Damage from bots gets multiplied by this 
	DamageFactorLMG = 0.77,				-- Original Damage from bots gets multiplied by this 
	DamageFactorPDW = 0.77,				-- Original Damage from bots gets multiplied by this 
	DamageFactorSniper = 0.77,			-- Original Damage from bots gets multiplied by this 
	DamageFactorShotgun = 0.77,			-- Original Damage from bots gets multiplied by this 
	DamageFactorPistol = 0.77,			-- Original Damage from bots gets multiplied by this 
