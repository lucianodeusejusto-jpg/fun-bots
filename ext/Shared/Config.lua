...
Config = {
	...
	DamageFactorKnife = 0.1,			-- Original Damage from bots gets multiplied by this 
	...
	VehicleGunshipAimWorsening = 1.2,	-- Make bots in Gunships aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehicleChopperAimWorsening = 1.0,	-- Make bots in Choppers aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	VehiclePlaneAimWorsening = 1.0,	-- See VehicleAimWorsening, only for Planes 
	DamageFactorVehicles = 0.3,			-- Original Damage from bots in vehicles gets multiplied by this 
